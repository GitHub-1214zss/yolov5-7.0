...
class yolov5_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        for i in trange(int(post_result.size(0) * self.ratio)):
            ...
            weights = self.method.get_cam_weights(self.method, None, None, None,
                                                  activations, gradients.detach().numpy())
            ...
            ))], f'{self.model_names[int(post_result[i, 1:].argmax())]} {post_result[i][0]:.2f}', cam_image)
...
if __name__ == '__main__':
    ...
    model('data/images/zidane.jpg', 'heat_map_result')
